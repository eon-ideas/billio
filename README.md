...
- Secure data storage
- AI-powered support chat with context-aware responses

## Support Chat

The application includes an AI-powered support chat that can help you with questions about your customers and invoices. The chat uses advanced retrieval techniques to provide accurate, context-aware responses based on your actual data.
...
- "Show me all information about customer [customer name]"
- "Which customers are from [city]?"
- "List all customers with unpaid invoices"
- "How many customers do we have in total?"
- "What is the VAT ID for [company name]?"

#### Invoice Details
- "Show me all invoices for [customer name]"
- "What's the total amount of unpaid invoices?"
- "List invoices due this month"
- "When was the last invoice created for [customer name]?"
- "Show me invoices with amounts greater than [amount]"

#### Payment and Status
- "Which invoices are overdue?"
- "What's the payment status for invoice #[number]?"
- "Show me all paid invoices for [customer name]"
- "What's the total revenue from [customer name]?"
- "List all invoices paid in the last month"

#### Analysis and Summary
- "What's our total revenue this year?"
- "Who are our top 5 customers by invoice value?"
- "Show me the monthly invoice breakdown"
- "Which customers have the most unpaid invoices?"
- "What's the average invoice amount for [customer name]?"

The chat window is resizable and can be accessed from any page in the application. Simply click the chat button in the lower right corner to start asking questions.
