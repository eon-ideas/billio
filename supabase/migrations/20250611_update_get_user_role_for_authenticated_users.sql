-- Update get_user_role function to only return roles for authenticated users
-- This ensures that unauthenticated calls return NULL instead of attempting to assign a role
