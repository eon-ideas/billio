-- Ensure the first user is assigned the ADMIN role and update policies
...
DROP POLICY IF EXISTS "Admins can access company_info" ON company_info;
...
-- Create new policies with first_user fallback
